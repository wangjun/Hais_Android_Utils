...
public class CrashUtil implements UncaughtExceptionHandler {
	public static final String LOG_PATH = "app_log";
	...
	public void init(Context context) {
		mContext = context;
		//app = (ZHSApplication) mContext.getApplicationContext();
	...
	private boolean handleException(Throwable ex) {
		...
		new Thread() {
			...
			public void run() {
				Looper.prepare();
				Toast.makeText(mContext, "系统崩溃,请查看'"+LOG_PATH+"/" + fileName + "'日志", Toast.LENGTH_LONG).show();
				Looper.loop();
			}
		}.start();
		// 收集设备参数信息
